...
(CuadroChalanes/ChalanAsignado). Si falla con ErrorTransitorio o
FaltaCredencial, sigue con el resto de la CadenaFallback, marcando cada
intento posterior con `es_fallback=True` + `proveedor_original=<primario>`.
