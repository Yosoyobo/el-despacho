...
CONSULTAS_CHAT: list[dict] = [
    ...
    {"nombre": "resumen_margenes / resumen_rentabilidad", "que": "Cuánto dejó de verdad cada proyecto: vendido, costo real de materiales y procesos, utilidad y margen, más cuáles están debajo del margen sano o en pérdida (requiere permiso de Finanzas). Pregunta: «¿en qué proyectos estamos perdiendo dinero?»."},
    ...
    {"nombre": "ruta_del_dia", "que": "Tu vuelta de hoy: los mandados abiertos ordenados por cercanía y los kilómetros aproximados. Pregunta: «¿cuál es mi ruta?»."},
